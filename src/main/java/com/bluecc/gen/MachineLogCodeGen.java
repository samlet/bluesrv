 ...
 */
public class MachineLogCodeGen extends CodeGenBase {
    public final DataSourceConfig dataSourceConfig =
            new DataSourceConfig.Builder("jdbc:clickhouse://localhost:8123/mgbench",
                    "default",
                    "")
